...
class CreateWarehouseNhuakythuatcayongsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_nhuakythuatcayongs', function (Blueprint $table) {
            $table->id();
            $table->string('code');
    ...
    {
        Schema::dropIfExists('warehouse_nhuakythuatcayongs');
    }
}
