...
class CreateWarehousePtfetapesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_ptfetapes', function (Blueprint $table) {
            $table->id();
            $table->string('code');
    ...
    {
        Schema::dropIfExists('warehouse_ptfetapes');
    }
}
