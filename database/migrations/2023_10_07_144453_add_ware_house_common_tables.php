...
class AddWareHouseCommonTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('base_warehouses', function (Blueprint $table) { 
            ...
            $table->float('do_day',12,4)->nullable();
            $table->string('hinh_dang')->nullable();
            $table->float('dia_w_w1',12,4)->nullable();
            $table->float('l_l1',12,4)->nullable();
            $table->float('w2',12,4)->nullable();
            $table->float('l2',12,4)->nullable();
            $table->integer('sl_tam')->nullable();
            $table->float('sl_m2',12,4)->nullable();
            $table->string('lot_no')->nullable();
            $table->string('ghi_chu')->nullable();
            $table->date('date')->nullable();
            $table->integer('ton_sl_tam')->nullable();
            $table->float('ton_sl_m2',12,4)->nullable();
            $table->string('size')->nullable();
            $table->float('trong_luong_cuon',12,4)->nullable();
            $table->float('m_cuon',12,4)->nullable();
            $table->integer('sl_cuon')->nullable();
            $table->float('sl_kg',12,4)->nullable();
            $table->integer('ton_sl_cuon')->nullable();
            $table->float('ton_sl_kg',12,4)->nullable();
            $table->float('sl_m',12,4)->nullable();
            $table->float('d1',12,4)->nullable();
            $table->float('d2',12,4)->nullable();
            ...
            $table->float('m_cay',12,4)->nullable();
