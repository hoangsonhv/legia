...
class CreateWarehouseCaosuvnzasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_caosuvnzas', function (Blueprint $table) {
            $table->id();
            $table->string('code');
    ...
    {
        Schema::dropIfExists('warehouse_caosuvnzas');
    }
}
