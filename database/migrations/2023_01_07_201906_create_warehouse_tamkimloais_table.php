...
class CreateWarehouseTamkimloaisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_tamkimloais', function (Blueprint $table) {
            $table->id();
            $table->string('code');
    ...
    {
        Schema::dropIfExists('warehouse_tamkimloais');
    }
}
