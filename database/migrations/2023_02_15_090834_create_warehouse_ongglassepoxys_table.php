...
class CreateWarehouseOngglassepoxysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_ongglassepoxys', function (Blueprint $table) {
            $table->id();
            $table->string('code');
    ...
    {
        Schema::dropIfExists('warehouse_ongglassepoxys');
    }
}
