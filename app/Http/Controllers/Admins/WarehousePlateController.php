...
class WarehousePlateController extends Controller
{
    ...
    public function store(WarehousePlateRequest $request, $model)
    {
        ...
        if ($this->warehousePlateRepository->store($model, $input)) {
    ...
    public function edit(Request $request, $model, $id)
    {
        ...
        $warehousePlate = $this->warehousePlateRepository->find($model, $id);
        if ($warehousePlate) {
            $permissions = config('permission.permissions');
    ...
    public function update(WarehousePlateRequest $request, $model, $id)
    {
        ...
        $warehousePlate = $this->warehousePlateRepository->find($model, $id);
        if ($warehousePlate) {
            $this->warehousePlateRepository->update($model, $input, $warehousePlate);
