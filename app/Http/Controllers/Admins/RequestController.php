            ...
            foreach($inputMaterials['code'] as $key => $code) {
                ...
                if(in_array($category, array_keys($categories))) {
                    ...
                    $materials[] = [
                        ...
                        'code'          => $inputMaterials['code'][$key],
                        'mo_ta'         => $inputMaterials['mo_ta'][$key],
                        'do_day'        => isset($inputMaterials['do_day']) ? $inputMaterials['do_day'][$key] : null,
                        'hinh_dang'     => isset($inputMaterials['hinh_dang']) ? $inputMaterials['hinh_dang'][$key] : null,
                        'dia_w_w1'      => isset($inputMaterials['dia_w_w1']) ? $inputMaterials['dia_w_w1'][$key] : null,
                        'l_l1'          => isset($inputMaterials['l_l1']) ? $inputMaterials['l_l1'][$key] : null,
                        'w2'            => isset($inputMaterials['w2']) ? $inputMaterials['w2'][$key] : null,
                        'l2'            => isset($inputMaterials['l2']) ? $inputMaterials['l2'][$key] : null,
