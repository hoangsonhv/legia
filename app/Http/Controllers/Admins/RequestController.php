...
class RequestController extends Controller
{
    ...
    public function create(Request $request, $coId=null)
    {
        ...
        if ($coId) {
            ...
            $listWarehouse = $this->coService->getProductMaterialsInWarehouses($queryCo->first()->warehouses->pluck('code')->toArray(), true);
        } else {
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($requestModel) {
            ...
            if ($requestModel->co_id) {
                ...
                $warehouses    = $queryCo->first()->warehouses;
                $listWarehouse = $this->coService->getProductMaterialsInWarehouses($queryCo->first()->warehouses->pluck('code', 'id')->toArray(), true);
