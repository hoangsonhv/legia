    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        {!! Form::model($model, array('route' => ['admin.price-survey.update', $model->id], 'method' => 'patch', 'enctype' => 'multipart/form-data')) !!}
                        {!! Form::hidden('id', null) !!}
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xl-12">
                                    <div class="form-group">
                                        ...
                                        @php
                                        $survey_price = App\Models\SurveyPrice::query()->where('core_price_survey_id', $model->id)->first();
                                        @endphp
                                        @if($survey_price)
