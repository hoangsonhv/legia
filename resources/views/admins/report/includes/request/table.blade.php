        ...
        @foreach($datas as $index => $data)
            <tr>
                ...
                <td class="text-center">
                    <a class="text-primary" href="{{route('admin.request.index',
                        array_merge([
                ...
                <td class="text-center">
                    <a class="text-success" href="{{route('admin.request.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
                ...
                <td class="text-center">
                    <a class="text-danger" href="{{route('admin.request.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
                ...
                <td class="text-center text-info">
                    <a class="text-info" href="{{route('admin.request.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
                ...
                <td class="text-center text-danger">
                    <a class="text-info" href="{{route('admin.request.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
                            'status' => \App\Enums\ProcessStatus::PendingSurveyPrice,
                        ],$arrRequest))}}"
                    >
                        <b>{{$data->sum_pending_survey_price}}</b>
                    </a>
                </td>
            </tr>
        @endforeach
