<div class="table-responsive">
    <table class="table table-hover text-nowrap">
        ...
        <tr>
            ...
            <th class="text-center">
                Không cần xét duyệt/Đang chờ xử lý
            </th>
        </tr>
        </thead>
        <tbody>
        @foreach($datas as $index => $data)
            <tr>
                ...
                <td class="text-center">
                    <a class="text-primary" href="{{route('admin.co-tmp.index',
                        array_merge([
                ...
                <td class="text-center">
                    <a class="text-success" href="{{route('admin.co-tmp.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
                ...
                <td class="text-center">
                    <a class="text-danger" href="{{route('admin.co-tmp.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
                ...
                <td class="text-center text-info">
                    <a class="text-info" href="{{route('admin.co-tmp.index',
                        array_merge([
                            'admin_id' => $data->admin_id,
