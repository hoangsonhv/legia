            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card form-root">
                        {!! Form::model($model, array('route' => ['admin.warehouse-receipt.update', $model->id], 'method' => 'patch', 'enctype' => 'multipart/form-data')) !!}
                        {!! Form::hidden('id', null) !!}
                        <div class="card-body">
                            <div class="form-group">
                                <label for="shipping_unit">Mã phiếu nhập kho<b style="color: red;">(*)</b></label>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function removeFile(_this) {
            $.ajax({
                method: "POST",
                url: "{{ route('admin.warehouse-receipt.remove-file') }}",
