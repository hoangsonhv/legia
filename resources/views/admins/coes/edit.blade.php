    ...
    <section class="content">
        <div class="container-fluid">
            @include('admins.includes.approval', [
                ...
                'status' => $co->status,
                'check_warehouse' =>
                    $co->currentStep && $co->currentStep->step === \App\Models\CoStepHistory::STEP_CHECKWAREHOUSE
                        ? true
                        : false,
            ])
            <div class="row">
                                ...
                                @if ($co->start_timeline)
                                    <div class="card-body">
                                        @php
                                            ...
                                            $curentTime = \Carbon\Carbon::parse(
                                        ...
                                        @if ($co->enough_money)
                                            <h5 class="text-primary">
                                                Thời gian hoàn tất thu tiền:
                                                {{ \Carbon\Carbon::parse($co->enough_money)->format('Y-m-d H:i:s') }}
                                            </h5>
                                        @else
                                            <h5
                                                class="{{ $numberTime <= 15 ? 'text-success' : ($numberTime <= 30 ? 'text-warning' : 'text-danger') }}">
                                            ...
                                            <div class="events">
                                                <ol>
                                                    <ul>
                                                        <li>
                                                            <span
                                                                class="text-success step1{{ $numberTime >= 15 ? ' selected' : '' }}">15
                                                                ngày</a>
                                                        </li>
                                                        <li>
                                                            <span
                                                                class="text-warning step2{{ $numberTime >= 30 ? ' selected' : '' }}">30
                                                                ngày</span>
                                                        </li>
                                                        <li>
                                                            <span
                                                                class="text-danger step3{{ $numberTime >= 45 ? ' selected' : '' }}">
                                                                45 ngày</span>
                                                        </li>
                                                    </ul>
                                                </ol>
                            ...
                            <div class="card" id="block-offer-price">
                                ...
                                <div class="card-body offer-price" style="display: none" id="card-table-co">
                                    @include('admins.coes.includes.list-products', [
                                        ...
                                        'material' => $listWarehouse,
                                        'collect' => true,
                                        'is_co' => true,
                                    ])
                                    @if (!empty($listWarehouse))
                                        @include('admins.coes.includes.list-warehouses', [
               ...
               @endif
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('co_code', $co->code, ['class' => 'form-control', 'readonly' => 'readonly']) !!}
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (json_decode($co->po_document, true))
                                                    <button type="button" class="btn btn-success" id="po_document_display"
                                                        data-toggle="modal" data-target="#po_document_modal"
                                                        content="{{ $co->po_document }}">Hiển thị chứng từ đã tồn
                                                        tại</button>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group block-file">
                                                    <div class="custom-file">
                                                        <input type="file" name="contract_document[]"
                                                ...
                                                @if (json_decode($co->contract_document, true))
                                                    <button type="button" class="btn btn-success"
                                                        id="contract_document_display" data-toggle="modal"
                                                        data-target="#contract_document_modal"
                                                        content="{{ $co->contract_document }}">Hiển thị chứng từ đã tồn
                                                        tại</button>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group block-file">
                                                    <div class="custom-file">
                                                        <input type="file" name="invoice_document[]"
                                                            class="custom-file-input" multiple />
                                                        <label class="custom-file-label">Chọn file</label>
                                                    </div>
                                                </div>
                                                ...
                                                @if (json_decode($co->invoice_document, true))
                                                    <button type="button" class="btn btn-success"
                                                        id="invoice_document_display" data-toggle="modal"
                                                        data-target="#invoice_document_modal"
                                                        content="{{ $co->invoice_document }}">Hiển thị chứng từ đã tồn
                                                        tại</button>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="customer[code]">Mã khách hàng<b style="color: red;">
                                                                (*)</b></label>
                                                        {!! Form::text('core_customer[code]', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xl-8">
                                                    <div class="form-group">
                                                        <label for="core_customer[ten]">Tên khách hàng<b
                                                                style="color: red;"> (*)</b></label>
                                                        {!! Form::text('core_customer[name]', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-8">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('core_customer[address]', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xl-4">
                                                    <div class="form-group">
                                                        <label for="core_customer[mst]">MST</label>
                                                        {!! Form::text('core_customer[tax_code]', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('customer[nguoi_nhan]', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="customer[dien_thoai]">Điện thoại</label>
                                                        {!! Form::text('customer[dien_thoai]', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::email('customer[email]', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="so_bao_gia">Số báo giá</label>
                                                        {!! Form::text('so_bao_gia', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" id="ngay_bao_gia"
                                                            data-target-input="nearest">
                                                            {!! Form::text('ngay_bao_gia', null, [
                                                                'class' => 'form-control datetimepicker-input',
                                                                'data-target' => '#ngay_bao_gia',
                                                            ]) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('thoi_han_bao_gia', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="dong_goi_va_van_chuyen">Đóng gói và vận chuyển</label>
                                                        {!! Form::text('dong_goi_va_van_chuyen', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('noi_giao_hang', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="xuat_xu">Xuất xứ</label>
                                                        {!! Form::text('xuat_xu', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::text('thoi_gian_giao_hang', null, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mt-3">
                                                <h5>
                                                    <p style="width: fit-content; padding: 5px 10px; border-radius: 5px; font-size:1rem;"
                                                ...
                                                <div class="table-responsive p-0">
                                                    <table class="table table-bordered text-wrap">
                                                        <thead>
                                                            <tr class="text-center">
                                                                ...
                                                                <th class="align-middle">
                                                                    ...
                                                                    @if (isset($receipts[0]))
                                                                        <a target="_blank"
                                                                            href={{ route('admin.receipt.edit', ['id' => $receipts[0]['id']]) }}>
                                                                            @if ($receipts[0]['status'] == 1)
                                                                                <span class="text-info ml-2"><i
                                                                                        class="fas fa-file"></i></span>
                                                                            @endif
                                                                            @if ($receipts[0]['status'] == 2)
                                                                                <span class="text-green ml-2"><i
                                                                ...
                                                                <th class="align-middle">
                                                                    ...
                                                                    @if (isset($receipts[1]))
                                                                        <a target="_blank"
                                                                            href={{ route('admin.receipt.edit', ['id' => $receipts[1]['id']]) }}>
                                                                ...
                                                                <th class="align-middle">
                                                                    ...
                                                                    @if (isset($receipts[2]))
                                                                        <a target="_blank"
                                                                            href={{ route('admin.receipt.edit', ['id' => $receipts[2]['id']]) }}>
                                                                ...
                                                                <th class="align-middle">
                                                                    ...
                                                                    @if (isset($receipts[3]))
                                                                        <a target="_blank"
                                                                            href={{ route('admin.receipt.edit', ['id' => $receipts[3]['id']]) }}>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-right" width="20%">% tổng giá trị đơn
                                                                    hàng</td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    {!! Form::text('thanh_toan[percent][thoi_gian_no]', null, ['class' => 'form-control text-center']) !!}
                                                                </td>
                                                            </tr>
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    @php
                                                                        $valVnd = number_format(
                                                                            old(
                                                                                'thanh_toan[amount_money][truoc_khi_lam_hang]',
                                                                                $co->thanh_toan['amount_money'][
                                                                                    'truoc_khi_lam_hang'
                                                                                ],
                                                                            ),
                                                                        );
                                                                    ...
                                                                    @endphp
                                                                    {!! Form::text('tmp[amount_money][truoc_khi_lam_hang]', $valVnd, [
                                                                        'class' => 'form-control text-center',
                                                                        'onKeyUp' => 'return getNumberFormat(this)',
                                                                    ]) !!}
                                                                    {!! Form::hidden('thanh_toan[amount_money][truoc_khi_lam_hang]', null, ['class' => 'form-control data-origin']) !!}
                                                                </td>
                                                                <td>
                                                                    @php
                                                                        $valVnd = number_format(
                                                                            old(
                                                                                'thanh_toan[amount_money][truoc_khi_giao_hang]',
                                                                                $co->thanh_toan['amount_money'][
                                                                                    'truoc_khi_giao_hang'
                                                                                ],
                                                                            ),
                                                                    ...
                                                                    @endphp
                                                                    {!! Form::text('tmp[amount_money][truoc_khi_giao_hang]', $valVnd, [
                                                                        'class' => 'form-control text-center',
                                                                        'onKeyUp' => 'return getNumberFormat(this)',
                                                                    ]) !!}
                                                                    {!! Form::hidden('thanh_toan[amount_money][truoc_khi_giao_hang]', null, ['class' => 'form-control data-origin']) !!}
                                                                </td>
                                                                <td>
                                                                    @php
                                                                        $valVnd = number_format(
                                                                            old(
                                                                                'thanh_toan[amount_money][ngay_khi_giao_hang]',
                                                                                $co->thanh_toan['amount_money'][
                                                                                    'ngay_khi_giao_hang'
                                                                                ],
                                                                            ),
                                                                    ...
                                                                    @endphp
                                                                    {!! Form::text('tmp[amount_money][ngay_khi_giao_hang]', $valVnd, [
                                                                        'class' => 'form-control text-center',
                                                                        'onKeyUp' => 'return getNumberFormat(this)',
                                                                    ]) !!}
                                                                    {!! Form::hidden('thanh_toan[amount_money][ngay_khi_giao_hang]', null, ['class' => 'form-control data-origin']) !!}
                                                                </td>
                                                                <td>
                                                                    @php
                                                                        $valVnd = number_format(
                                                                            old(
                                                                                'thanh_toan[amount_money][sau_khi_giao_hang_va_cttt]',
                                                                                $co->thanh_toan['amount_money'][
                                                                                    'sau_khi_giao_hang_va_cttt'
                                                                                ],
                                                                            ),
                                                                        );
                                                                        if (!$valVnd) {
                                                                    ...
                                                                    @endphp
                                                                    {!! Form::text('tmp[amount_money][sau_khi_giao_hang_va_cttt]', $valVnd, [
                                                                        'class' => 'form-control text-center',
                                                                        'onKeyUp' => 'return getNumberFormat(this)',
                                                                    ]) !!}
                                                                    {!! Form::hidden('thanh_toan[amount_money][sau_khi_giao_hang_va_cttt]', null, [
                                                                        'class' => 'form-control data-origin',
                                                                    ]) !!}
                                                                </td>
                                                                <td>
                                                                    @php
                                                                        $valVnd = number_format(
                                                                            old(
                                                                                'thanh_toan[amount_money][thoi_gian_no]',
                                                                                $co->thanh_toan['amount_money'][
                                                                                    'thoi_gian_no'
                                                                                ],
                                                                            ),
                                                                    ...
                                                                    @endphp
                                                                    {!! Form::text('tmp[amount_money][thoi_gian_no]', $valVnd, [
                                                                            ...
                                                                            @foreach ($paymentDocuments as $key => $doc)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="icheck-success">
                                                                                            {!! Form::checkbox('thanh_toan[payment_document][' . 'required_' . $key . ']', true, null, [
                                                                                                'id' => 'required_' . $key,
                                                                                            ]) !!}
                                                                                            <label
                                                                                                for={{ 'required_' . $key }}></label>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td class="text-center">
                                                                                        <div class="icheck-success">
                                                                                            {!! Form::checkbox('thanh_toan[payment_document][' . 'finished_' . $key . ']', true, null, [
                                                                                                'id' => 'finished_' . $key,
                                                                                            ]) !!}
                                                                                            <label
                                                                                                for={{ 'finished_' . $key }}></label>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td class="text-center">
                                                                                        <div class="row">
                                                                                            @if (isset($co->thanh_toan['payment_document']['document_id_' . $key]))
                                                                                                ...
                                                                                                @endforeach
                                                                                            @endif
                                                                                            @if (!isset($co->thanh_toan['payment_document']['finished_' . $key]))
                                                                                                {!! Form::file('thanh_toan[payment_document][' . 'document_id_' . $key . ']', null, [
                                                                                                    'id' => 'document_id_' . $key,
                                                                            ...
                                                                            <tr>
                                                                              ...
                                                                              <td>
                                                                                @if (isset($co->thanh_toan['payment_document']['khac']))
                                                                                  ...
                                                                                  @endforeach
                                                                                @endif
                                                                                <input name="thanh_toan[payment_document][khac]" type="file" multiple>
                                                                              </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <div class="float-right mt-3">
                                                                        @permission('admin.co.store')
                                                                            @if ($co->status == \App\Enums\ProcessStatus::Approved)
                                                                                ...
                                                                                <button type="submit"
                                                                                    class="btn btn-primary">Lưu thông tin chứng
                                                                                    từ</button>
                                                                            @endif
                                                                        @endpermission
                                                                    </div>
                                    ...
                                    @if (\App\Enums\ProcessStatus::Approved == $co->status)
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                @if ($co->request->count())
                                                    @php
                                                        $moneyData = \App\Helpers\DataHelper::getCategoryPayment(
                                                            \App\Helpers\DataHelper::DINH_KY,
                                                        );
                                                        array_push(
                                                            $moneyData,
                                                            \App\Helpers\DataHelper::KHO . '-chiet_khau',
                                                        );
                                                    @endphp
                                                    @foreach ($co->request as $key => $requestModel)
                                                        <div class="table-responsive">
                                                            <h5><b class="badge bg-warning">Phiếu Yêu Cầu lần
                                                                    {{ $key + 1 }}</b></h5>
                                                            <table class="table table-bordered text-wrap">
                                                                <tbody>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @php
                                                                                $accompanyingDocument = json_decode(
                                                                                    $requestModel->accompanying_document,
                                                                                    true,
                                                                                );
                                                                            @endphp
                                                                            @if ($accompanyingDocument)
                                                                                <button type="button" class="btn btn-success"
                                                                                    data-toggle="modal"
                                                                                    data-target="#accompanying_document_modal_request{{ $key }}">Hiển
                                                                                    thị chứng từ đã tồn tại</button>
                                                                            @else
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @php
                                                                                $accompanyingDocumentSurveyPrice = json_decode(
                                                                                    $requestModel->accompanying_document_survey_price,
                                                                                    true,
                                                                                );
                                                                            @endphp
                                                                            @if ($accompanyingDocumentSurveyPrice)
                                                                                <button type="button" class="btn btn-success"
                                                                                    data-toggle="modal"
                                                                                    data-target="#accompanying_document_survey_price_modal{{ $key }}">Hiển
                                                                                    thị chứng từ đã tồn tại</button>
                                                                            @else
                                                                                Không tồn tại chứng từ
                                                                            @endif
                                                                    ...
                                                                    @if ($requestModel->material->count())
                                                                        @foreach ($requestModel->material as $index => $material)
                                                                            <tr align="center">
                                                                                ...
                                                                                <td>{{ number_format($material->dinh_luong) }}
                                                                                </td>
                                                                        ...
                                                                        <table class="table table-bordered text-wrap">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td colspan="2">
                                                                                        <div class="icheck-success">
                                                                                            {!! Form::checkbox('survey_price[' . $indexSP . '][is_accept]', true, $surveyPrice->is_accept, [
                                                                                                'id' => 'is_accept' . $indexSP,
                                                                                                'disabled' => 'disabled',
                                                                                            ]) !!}
                                                                                            <label
                                                                                                for="{{ 'is_accept' . $indexSP }}">Khảo
                                                                                                Sát Giá
                                                                                                {{ $indexSP + 1 }}</label>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        @php
                                                                                            $accompanyingDocumentSurveyPrice = json_decode(
                                                                                                $surveyPrice->accompanying_document,
                                                                                                true,
                                                                                            );
                                                                                        @endphp
                                                                                        @if ($surveyPrice->core_price_survey_id)
                                                                                            <a class="btn btn-primary mb-2"
                                                                                                href="/admin/price-survey/edit/{{ $surveyPrice->core_price_survey_id }}"
                                                                                                target="_blank">
                                                                                                Xem chi tiết
                                                                                            </a><br />
                                                                                        @else
                                                                                        ...
                                                                                        @if ($accompanyingDocumentSurveyPrice)
                                                                                            <button type="button"
                                                                                                ...
                                                                                                data-toggle="modal"
                                                                                                data-target="#accompanying_document_survey_price_modal{{ $indexSP }}">Hiển
                                                                                                thị chứng từ đã tồn tại</button>
                                                                                        @endif
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header bg-success">
                                                                                        <h4 class="modal-title">Chứng từ khảo
                                                                                            sát giá</h4>
                                                        ...
                                                        @if ($accompanyingDocument)
                                                            <div class="modal fade"
                                                                id="accompanying_document_modal_request{{ $key }}">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-success">
                                                        ...
                                                        @if ($accompanyingDocumentSurveyPrice)
                                                            <div class="modal fade"
                                                                id="accompanying_document_survey_price_modal{{ $key }}">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-success">
                                                                            <h4 class="modal-title">Chứng từ</h4>
                                                ...
                                                @if ($co->payment->count())
                                                    ...
                                                    @foreach ($co->payment as $key => $payment)
                                                        <div class="table-responsive">
                                                            <h5><b class="badge bg-danger">Phiếu Chi lần
                                                                    {{ $key + 1 }}</b></h5>
                                                            <table class="table table-bordered text-wrap">
                                                                <tbody>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>Mã Phiếu Yêu Cầu</td>
                                                                        <td>{{ !empty($payment->co->first()) && $payment->co->first()->request->first() ? $payment->co->first()->request->first()->code : '' }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Danh mục</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @if ($accompanyingDocument)
                                                                                <button type="button" class="btn btn-success"
                                                                                    data-toggle="modal"
                                                                                    data-target="#accompanying_document_modal_payment{{ $key }}">Hiển
                                                                                    thị chứng từ đã tồn tại</button>
                                                                            @else
                                                                                Không tồn tại chứng từ
                                                                            @endif
                                                        ...
                                                        @if ($accompanyingDocument)
                                                            <div class="modal fade"
                                                                id="accompanying_document_modal_payment{{ $key }}">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-success">
                                                                            <h4 class="modal-title">Chứng từ</h4>
                                                ...
                                                @if ($co->receipt->count())
                                                    ...
                                                    @foreach ($co->receipt as $key => $receipt)
                                                        <div class="table-responsive ">
                                                            <h5><b class="badge bg-success">Phiếu Thu lần
                                                                    {{ $key + 1 }}</b></h5>
                                                            <table class="table table-bordered text-wrap">
                                                                <tbody>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>Mã Phiếu Chi</td>
                                                                        <td>{{ !empty($receipt->payment) ? $receipt->payment->code : '' }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Người thực hiện</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @if ($accompanyingDocument)
                                                                                <button type="button" class="btn btn-success"
                                                                                    data-toggle="modal"
                                                                                    data-target="#accompanying_document_modal_receipt{{ $key }}">Hiển
                                                                                    thị chứng từ đã tồn tại</button>
                                                                            @else
                                                                                Không tồn tại chứng từ
                                                                            @endif
                                                        ...
                                                        @if ($accompanyingDocument)
                                                            <div class="modal fade"
                                                                id="accompanying_document_modal_receipt{{ $key }}">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-success">
                                                                            <h4 class="modal-title">Chứng từ</h4>
                                    ...
                                    @if ($co->currentStep)
                                        @if (in_array($co->currentStep->step, [
                                            ...
                                            @permission('admin.receipt.create')
                                                <a href="{{ route('admin.receipt.create', ['type' => 'co', 'id' => $co->id]) }}"
                                                    class="btn btn-success">Tạo Phiếu Thu</a>
                                            @endpermission
                                        @endif
                                        @if ($co->currentStep->step == \App\Models\CoStepHistory::STEP_CREATE_REQUEST)
                                            @permission('admin.request.create')
                                                @if (\App\Enums\ProcessStatus::Approved == $co->status)
                                                    <a href="{{ route('admin.request.create', ['coId' => $co->id]) }}"
                                        ...
                                        @if ($co->currentStep->step == \App\Models\CoStepHistory::STEP_CREATE_WAREHOUSE_EXPORT_SELL)
                                            @permission('admin.warehouse-export-sell.create')
                                                @if (\App\Enums\ProcessStatus::Approved == $co->status)
                                                    <a href="{{ route('admin.warehouse-export-sell.create', ['co_id' => $co->id]) }}"
                                                        class="btn btn-success">
                                        ...
                                        @if ($co->currentStep->step == \App\Models\CoStepHistory::STEP_CREATE_WAREHOUSE_EXPORT)
                                            @permission('admin.warehouse-export.create')
                                                @if (\App\Enums\ProcessStatus::Approved == $co->status)
                                                    <a href="{{ route('admin.warehouse-export.create', ['co_id' => $co->id]) }}"
                                                        class="btn btn-success">
                                                        Tạo Phiếu xuất kho
                                                    </a>
                                                @endif
                                        ...
                                        @if ($co->currentStep->step == \App\Models\CoStepHistory::STEP_CREATE_MANUFACTURE)
                                            @permission('admin.manufacture.create')
                                                @if (\App\Enums\ProcessStatus::Approved == $co->status && !$co->manufacture)
                                                    <a href="{{ route('admin.manufacture.create', ['co_id' => $co->id]) }}"
                                                        class="btn btn-success">Tạo Sản xuất</a>
                                                @endif
                                            @endpermission
                                        @endif
                ...
                @include('admins.coes.includes.offer-price', [
                    'url' => route('admin.co.get-data-warehouse'),
                ])
            ...
            if (contentDocument) {
                ...
                if (data.length) {
                    $.each(data, function(index, value) {
                        ...
                        html += '<button type="button" class="btn btn-danger form-control" type-document="' +
                            field + '" onclick="removeFile(this)" data-path="' + value.path + '">Xoá file</button>';
                        html += '</div></div>';
