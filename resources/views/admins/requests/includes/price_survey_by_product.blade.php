{!! Form::open([
    'route' => 'admin.price-survey.insert-multiple',
    'method' => 'post',
    ...
    <tbody class="tbody-request-price-survey-{{ $material->id }}">
        @foreach ($material->price_survey as $index => $priceSurvey)
            ...
            <td>
                ...
                <td>
                    ...
                    <div class="d-block">
                        ...
                        @if ($surveyPrice)
                            ...
                            @endif
                            <div class="modal fade" id="accompanying_document_survey_price_modal{{ $surveyPrice->id }}">
                ...
                <td>
                    <input name="tmp_price[]" value="{{ number_format($priceSurvey->price) }}" class="form-control"
                        placeholder="giá trị báo giá" />
                    <input name="price[]" value="{{ $priceSurvey->price }}" type="hidden" />
                </td>
                <td>
                    <input name="number_date_wait_pay[]" value="{{ $priceSurvey->number_date_wait_pay }}"
                        type="number" class="form-control" placeholder="Số ngày quá hạn thanh toán" />
                </td>
                <td>
                ...
                <tr>
                    <td colspan="8">
                        <div class="float-right">
                            <span class="btn btn-primary btn-insert-request-price_survey"
                                onClick="insertRequestPriceSurvey({{ $material->id }})">
