    ...
    <div class="sidebar">
      ...
      <nav class="">
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item{{ (strpos(url()->current(), '/admin/dashboard/index/co-tmps') !== false || (strpos(url()->current(), '/admin/dashboard/index/coes') !== false) || (strpos(url()->current(), '/admin/dashboard/index/treking') !== false) || (strpos(url()->current(), '/admin/dashboard/index/requests') !== false)) ? ' menu-open' : '' }}">
            <a href="#" class="nav-link{{ (strpos(url()->current(), '/admin/dashboard/index/co-tmps') !== false) || (strpos(url()->current(), '/admin/dashboard/index/coes') !== false) || (strpos(url()->current(), '/admin/dashboard/index/treking') !== false) || (strpos(url()->current(), '/admin/dashboard/index/requests') !== false) ? ' active' : '' }}">
            ...
            <ul class="nav nav-treeview">
              ...
              @endpermission
              @permission('admin.treking.index')
              <li class="nav-item">
                <a href="{{ route('admin.dashboard.treking') }}" class="nav-link{{ (strpos(url()->current(), '/admin/dashboard/index/treking') !== false) ? ' active' : '' }}">
                  <p>Treking CO</p>
                </a>
              </li>
              @endpermission
