...
function getItem(index, unit, opts) {
    return '<tr align="center">'
        ...
        + '<td class="name"><textarea class="form-control" name="product[name][]" rows="1">'+opts.name+'</textarea></td>'
        + '<td class="code"><input class="form-control" type="text" name="product[code][]" value="'+opts.code+'"></td>'
