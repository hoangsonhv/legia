...
function getItem(index, unit, opts) {
    ...
    return '<tr align="center">'
        ...
        + '<td class="code"><input type="hidden" name="product[merchandise_id][]" value="'+opts.merchandise_id+'"><input style="width: 130px" readonly class="form-control" type="text" name="product[code][]" value="'+opts.code+'"></td>'
        + '<td class=""><textarea readonly class="form-control" name="product[name][]" style="width: 170px" rows="1">'+opts.vat_lieu+'</textarea></td>'
        + '<td class="code"><input readonly class="form-control" style="width: 80px" type="text" name="product[do_day][]" value="'+opts.do_day+'"></td>'
        + '<td class="code"><input readonly class="form-control" style="width: 150px" type="text" name="product[tieu_chuan][]" value="'+opts.tieu_chuan+'"></td>'
